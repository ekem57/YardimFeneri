...
class SohbetPageCharities extends StatefulWidget {
  final String fotourl;
  final String userad;
  final String soyad;
  final String userid;

  SohbetPageCharities({ this.fotourl,this.userad,this.soyad,this.userid});
  @override
  _SohbetPageCharitiesState createState() => _SohbetPageCharitiesState();
}

class _SohbetPageCharitiesState extends State<SohbetPageCharities> {
  ...
  Widget build(BuildContext context) {
    final _chatModel = Provider.of<ChatViewModelCharities>(context);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.userad+" "+widget.soyad),
        elevation: 0.0,
  ...
  Widget _buildMesajListesi() {
    return Consumer<ChatViewModelCharities>(builder:
  ...
  void eskiMesajlariGetir() async {
    final _chatModel = Provider.of<ChatViewModelCharities>(context,listen: false);
    if (_isLoading == false) {
      _isLoading = true;
