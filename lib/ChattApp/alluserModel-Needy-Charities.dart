...
enum AllUserViewStateNeedy_Charities { Idle, Loaded, Busy }

class AllUserViewModelNeedy_Charities with ChangeNotifier {
  AllUserViewStateNeedy_Charities _state = AllUserViewStateNeedy_Charities.Idle;
  ...
  AllUserViewStateNeedy_Charities get state => _state;

  set state(AllUserViewStateNeedy_Charities value) {
    _state = value;
    notifyListeners();
  }

  AllUserViewModelNeedy_Charities() {
    _tumKullanicilar = [];
    tumKonusma=[];
  ...
  getUserWithPagination(CharitiesModel enSonGetirilenUser, bool yeniElemanlarGetiriliyor,String userid) async {
    ...
    if (yeniElemanlarGetiriliyor) {
      ...
      state = AllUserViewStateNeedy_Charities.Busy;
    }
    ...
    _streamSubscription = _userRepository.getAllConversations(userid)
      ...
      state = AllUserViewStateNeedy_Charities.Loaded;
