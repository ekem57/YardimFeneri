...
enum ChatViewStateNeedy_Charities { Idle, Loaded, Busy }

class ChatViewModelNeedy_Charities with ChangeNotifier {
  List<Mesaj> _tumMesajlar;
  ChatViewStateNeedy_Charities _state = ChatViewStateNeedy_Charities.Idle;
  ...
  ChatViewModelNeedy_Charities({this.currentUser,this.sohbetEdilenUser}) {
    _tumMesajlar = [];
    _tumMesajlarTers=[];
  ...
  ChatViewStateNeedy_Charities get state => _state;

  set state(ChatViewStateNeedy_Charities value) {
    _state = value;
    notifyListeners();
  }
  ...
  void getMessageWithPagination(bool yeniMesajlarGetiriliyor) async {
    ...
    if (!yeniMesajlarGetiriliyor) state = ChatViewStateNeedy_Charities.Busy;
    ...
    state = ChatViewStateNeedy_Charities.Loaded;
