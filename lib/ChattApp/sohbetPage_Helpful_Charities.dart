...
class SohbetPageHelpful_Charities extends StatefulWidget {
  final String fotourl;
  final String userad;
  final String userid;

  SohbetPageHelpful_Charities({ this.fotourl,this.userad,this.userid});
  @override
  _SohbetPageHelpful_CharitiesState createState() => _SohbetPageHelpful_CharitiesState();
}

class _SohbetPageHelpful_CharitiesState extends State<SohbetPageHelpful_Charities> {
  ...
  Widget build(BuildContext context) {
    final _chatModel = Provider.of<ChatViewModelHelpful_Charities>(context);
    return Scaffold(
      backgroundColor:  Colors.green,
      appBar: AppBar(
        title: Text(widget.userad),
        elevation: 0.0,
      ...
      body: _chatModel.state == ChatViewStateHelpful_Charities.Busy
          ? Center(
  ...
  Widget _buildMesajListesi() {
    return Consumer<ChatViewModelHelpful_Charities>(builder: (context, chatModel, child) {
      return Expanded(
  ...
  void eskiMesajlariGetir() async {
    final _chatModel = Provider.of<ChatViewModelHelpful_Charities>(context,listen: false);
    if (_isLoading == false) {
      _isLoading = true;
