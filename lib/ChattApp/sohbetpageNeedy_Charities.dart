...
class SohbetPageNeedy_Charities extends StatefulWidget {
  final String fotourl;
  final String userad;
  final String userid;

  SohbetPageNeedy_Charities({ this.fotourl,this.userad,this.userid});
  @override
  _SohbetPageNeedy_CharitiesState createState() => _SohbetPageNeedy_CharitiesState();
}

class _SohbetPageNeedy_CharitiesState extends State<SohbetPageNeedy_Charities> {
  ...
  Widget build(BuildContext context) {
    final _chatModel = Provider.of<ChatViewModelNeedy_Charities>(context);
    return Scaffold(
      ...
      body: _chatModel.state == ChatViewStateNeedy_Charities.Busy
          ? Center(
  ...
  Widget _buildMesajListesi() {
    return Consumer<ChatViewModelNeedy_Charities>(builder: (context, chatModel, child) {
      return Expanded(
  ...
  void eskiMesajlariGetir() async {
    final _chatModel = Provider.of<ChatViewModelNeedy_Charities>(context,listen: false);
    if (_isLoading == false) {
      _isLoading = true;
