...
class YardimaIhtiyacKampanyaKatilimHelpful extends StatefulWidget {
  String yardim_id;
  String kurum;
  String kampanya_ismi;
  String bagis;
  YardimaIhtiyacKampanyaKatilimHelpful({Key key, this.yardim_id, this.kurum,this.bagis, this.kampanya_ismi}) : super(key: key);


  @override
  _YardimaIhtiyacKampanyaKatilimHelpfulState createState() => _YardimaIhtiyacKampanyaKatilimHelpfulState();
}

class _YardimaIhtiyacKampanyaKatilimHelpfulState extends State<YardimaIhtiyacKampanyaKatilimHelpful> {
  PickedFile _image;
  var imageUrl;
