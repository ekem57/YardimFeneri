...
class KampanyaDestekGondermeNeedy extends StatefulWidget {
  String yardim_id;
  String kurum;
  String kampanya_ismi;
  String bagis;
  KampanyaDestekGondermeNeedy({Key key,@required this.yardim_id,@required this.kurum,this.bagis,@required this.kampanya_ismi}) : super(key: key);


  @override
  _KampanyaDestekGondermeNeedyState createState() => _KampanyaDestekGondermeNeedyState();
}

class _KampanyaDestekGondermeNeedyState extends State<KampanyaDestekGondermeNeedy> {
  PickedFile _image;
  var imageUrl;
  ...
  Widget build(BuildContext context) {
    final _needyModel = Provider.of<HelpfulService>(context, listen: true);
