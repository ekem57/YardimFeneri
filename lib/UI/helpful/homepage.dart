...
import 'package:yardimfeneri/UI/helpful/needyKampanyaDestek.dart';
import 'package:yardimfeneri/UI/helpful/yardima_ihtiyac_needy.dart';
...
class _HomePageHelpfulState extends State<HomePageHelpful>  with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    HelpfulService _userModel = Provider.of<HelpfulService>(context);
    return SafeArea(
      child: Scaffold(
          appBar: AppBar(
...
//                                                      Navigator.push(context, MaterialPageRoute(builder: (context) =>KulupDetay(kulupid: _card["topid"].toString(),)),);
                            ...
                            {
                              Navigator.push(context, MaterialPageRoute(builder: (context) =>YardimaIhtiyacKampanyaKatilimHelpful(yardim_id: _card['yardim_id'].toString(),kurum:_card['kurumid'].toString(),bagis:_card['toplanan'].toString())),);
                            },
...
//                                                      Navigator.push(context, MaterialPageRoute(builder: (context) =>KulupDetay(kulupid: _card["topid"].toString(),)),);
                        ...
                        child = Column(
                          children: <Widget>[
                            ...
                            {
                              Navigator.push(context, MaterialPageRoute(builder: (context) =>KampanyaDestekGondermeNeedy(yardim_id: _card['postid'].toString(),kurum:_card['kurumid'].toString(),bagis:_card['toplanan_tutar'].toString())),);
