...
import 'package:yardimfeneri/UI/needy/yardima_ihtiyac_needy.dart';
...
class _HomePageNeedyState extends State<HomePageNeedy>  with SingleTickerProviderStateMixin{
...
//                                                      Navigator.push(context, MaterialPageRoute(builder: (context) =>KulupDetay(kulupid: _card["topid"].toString(),)),);
                            ...
                            {
                              Navigator.push(context, MaterialPageRoute(builder: (context) =>YardimaIhtiyacKampanyaKatilimNeedy(yardim_id: _card['yardim_id'].toString(),kurum:_card['kurumid'].toString(),bagis:_card['toplanan'].toString())),);
                            },
