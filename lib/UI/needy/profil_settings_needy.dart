...
class ProfilSettingsNeedy extends StatefulWidget {
  NeedyModel user;

  ProfilSettingsNeedy({Key key,this.user}) : super(key: key);

  @override
  _ProfilSettingsNeedyState createState() => _ProfilSettingsNeedyState();
}

class _ProfilSettingsNeedyState extends State<ProfilSettingsNeedy> {
  PickedFile _image;
  var imageUrl;
              ...
              child: MyButton(text: "Kaydet", onPressed: () async {
                ...
                try {
                  DocumentReference _reference = await FirebaseFirestore.instance
                      .collection("needy").doc(_helpfulService.user.userId);
