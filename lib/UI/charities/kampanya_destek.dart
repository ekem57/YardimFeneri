...
import 'package:yardimfeneri/UI/charities/kampanya_odeme.dart';
...
class KampanyaDestekGonderme extends StatefulWidget {
  String yardim_id;
  String kurum;
  String kampanya_ismi;
  String bagis;
  KampanyaDestekGonderme({Key key,@required this.yardim_id,@required this.kurum,this.bagis,@required this.kampanya_ismi}) : super(key: key);


  @override
  _KampanyaDestekGondermeState createState() => _KampanyaDestekGondermeState();
}

class _KampanyaDestekGondermeState extends State<KampanyaDestekGonderme> {
  PickedFile _image;
  var imageUrl;
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: MyButton(text: "Kampanyaya Katıl", onPressed: () async {

              Map<String, dynamic> destek = Map();

              destek['userid'] = _charitiesModel.user.userId;
              destek['isim'] = _charitiesModel.user.isim;
              destek['soyisim'] = "Kuruluşu";
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) =>KampanyaOdeme(destek: destek,bagis: widget.bagis,)),);
