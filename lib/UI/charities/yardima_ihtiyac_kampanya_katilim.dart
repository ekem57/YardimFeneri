...
class YardimaIhtiyacKampanyaKatilim extends StatefulWidget {
  String yardim_id;
  String kurum;
  String kampanya_ismi;
  String bagis;
  YardimaIhtiyacKampanyaKatilim({Key key, this.yardim_id, this.kurum,this.bagis, this.kampanya_ismi}) : super(key: key);


  @override
  _YardimaIhtiyacKampanyaKatilimState createState() => _YardimaIhtiyacKampanyaKatilimState();
}

class _YardimaIhtiyacKampanyaKatilimState extends State<YardimaIhtiyacKampanyaKatilim> {
  PickedFile _image;
  var imageUrl;
