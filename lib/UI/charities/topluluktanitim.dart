...
class ToplulukTanitim extends StatefulWidget {
  final String kurumid;
  const ToplulukTanitim({Key key,@required this.kurumid}) : super(key: key);

  @override
  _ToplulukTanitimState createState() => _ToplulukTanitimState();
}

class _ToplulukTanitimState extends State<ToplulukTanitim> {
  @override
