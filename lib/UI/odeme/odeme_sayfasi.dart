...
class PaymentPage extends StatefulWidget {
  ...
  String bagis;
  PaymentPage({Key key, this.destek,this.bagis}) : super(key: key);
  ...
  _pay2() async {
    ...
    if(paymentResult.status=="success")
    {
      ...
      try {
        ...
        bildirim['icerik'] = "Kişiye yapılan desteklere "+widget.destek['bagis_miktari'].toString()+" ₺ değerinde destek yapılmıştır.";
